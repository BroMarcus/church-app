...
export default function ServeError({reset}:{reset:()=>void}){
  return <main style={{maxWidth:980,margin:'0 auto',padding:'28px 18px 80px'}}>
    <div role="alert" style={{border:'1px solid #fecaca',borderRadius:18,padding:24,background:'#fff'}}>
      ...
      <h1 style={{margin:'10px 0 8px'}}>Serve could not load.</h1>
      <p style={{margin:'0 0 16px',color:'#6b7280'}}>No ministry application, qualification, or assignment was changed. / No se modificó ninguna solicitud, requisito ni asignación de ministerio.</p>

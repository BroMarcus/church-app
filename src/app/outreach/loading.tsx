export default function OutreachLoading(){
  return <main style={{maxWidth:980,margin:'0 auto',padding:'28px 18px 80px'}} aria-busy="true" aria-live="polite">
    <div style={{border:'1px solid #e5e7eb',borderRadius:18,padding:24,background:'#fff'}}>
      ...
      <h1 style={{margin:'10px 0 8px'}}>Loading outreach follow-up…</h1>
      <p style={{margin:0,color:'#6b7280'}}>Preparando el seguimiento de evangelismo… No contact, assignment, or follow-up is being changed while this loads. / No se está cambiando ningún contacto, asignación ni seguimiento mientras carga.</p>
    </div>
  </main>
}

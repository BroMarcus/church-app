...
const intents=[
  ...
  {words:['journey','testimony','journal','answered prayer','my story','testimonio','diario','oración contestada','oracion contestada','mi camino','milestone','milestone'],href:'/journey',label:['My Journey','Mi Camino'],reply:['I can help you review your discipleship journey, milestones and testimony history.','Puedo ayudarte a revisar tu camino de discipulado, logros e historial de testimonios.']},
...
export function ProphetCommandBox({lang}:Props){
  ...
  return <section className="card" style={{padding:18,marginBottom:18}}>
    ...
    <div className="row" style={{alignItems:'flex-start',marginTop:10}}><Sparkles size={22}/><div><h2 style={{margin:'0 0 5px'}}>{es?'Escribe como hablas normalmente.':'Type it the way you would normally say it.'}</h2><p className="small muted" style={{margin:0}}>{es?'Ejemplos: “¿Cuándo me toca servir?”, “Necesito reportar el grupo”, “¿Quién necesita seguimiento?”, o “Quiero continuar mi clase”.':'Examples: “When do I serve?”, “I need to report my group,” “Who needs follow-up?”, or “I want to continue my class.”'}</p></div></div>

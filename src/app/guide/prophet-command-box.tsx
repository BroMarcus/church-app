...
type Props={lang:'en'|'es';resumeCourse?:{id:string;title:string}|null}
...
const intents=[
  ...
  {words:['my journal','journal entry','my prayer','answered prayer','save a prayer','my testimony','spiritual note','private journal','mi diario','entrada de diario','mi oración','mi oracion','oración contestada','oracion contestada','guardar una oración','guardar una oracion','mi testimonio','nota espiritual'],href:'/journey/memories',label:['My Journey Memories','Recuerdos de Mi Jornada'],reply:['I can take you to your private Journey memories to save prayers, answered prayers, journal entries, testimonies and spiritual notes.','Puedo llevarte a los recuerdos privados de Mi Jornada para guardar oraciones, oraciones contestadas, diario, testimonios y notas espirituales.']},
  {words:['church testimonies','shared testimonies','show testimonies','testimonies from church','testimonios de la iglesia','testimonios compartidos','mostrar testimonios'],href:'/testimonies',label:['Church Testimonies','Testimonios de la Iglesia'],reply:['I can show you testimonies members chose to share and leadership approved for the church.','Puedo mostrarte testimonios que los miembros eligieron compartir y que el liderazgo aprobó para la iglesia.']},
  ...
  {words:['class','course','test','exam','learn','learning','clase','curso','prueba','examen','aprender','next lesson','siguiente lección','siguiente leccion','continue my class','resume course','continuar mi clase','reanudar curso'],href:'/learning',label:['Learning Center','Centro de Aprendizaje'],reply:['I can help you continue a class, find your next lesson, or see your discipleship progress.','Puedo ayudarte a continuar una clase, encontrar tu siguiente lección o ver tu progreso de discipulado.']},
  {words:['prayer request','pastoral prayer','pray for me','pastoral','help','petición de oración','peticion de oracion','oración pastoral','oracion pastoral','oren por mi','pastoral','ayuda','counseling','consejería','consejeria'],href:'/help',label:['Prayer & Pastoral Care','Oración y Cuidado Pastoral'],reply:['I can take you to the private prayer and pastoral-care area. Sensitive requests stay in the proper permission boundary.','Puedo llevarte al área privada de oración y cuidado pastoral. Las solicitudes sensibles permanecen dentro de los permisos correctos.']},
  {words:['journey','my story','mi camino','milestone','my milestones','mis hitos'],href:'/journey',label:['My Journey','Mi Camino'],reply:['I can help you review your discipleship journey, verified milestones, learning, groups and serving history.','Puedo ayudarte a revisar tu camino de discipulado, hitos verificados, aprendizaje, grupos e historial de servicio.']},
...
export function ProphetCommandBox({lang,resumeCourse=null}:Props){
  ...
  const targetHref=match?.href==='/learning'&&resumeCourse?`/learning/${resumeCourse.id}`:match?.href
  const targetLabel=match?.href==='/learning'&&resumeCourse?resumeCourse.title:match?.label[es?1:0]
  ...
  const go=()=>{if(targetHref)router.push(`${targetHref}${es?'?lang=es':''}`)}

...
const copy={
  en:{title:'What are you trying to do?',subtitle:'Pick one thing. Kingdom Guide will take you to the right place.',searchTitle:'Search church resources',searchBody:'Looking for a lesson, Scripture topic, policy, form or church resource?',search:'Search',placeholder:'Try: baptism, prayer, First Steps, giving…',hint:'Results come from resources already stored by your church. Kingdom Guide does not invent doctrine or silently replace the source.',quick:'COMMON THINGS',leadership:'CHURCH SETUP & LEADERSHIP',results:'TRUSTED RESULTS',resultsFor:'Results for',none:'No matching church resource was found. Try a simpler word or open the Resource Library.',open:'Open in Resource Library →',trust:'WHY THIS IS SAFE',trustTitle:'The source stays visible.',trustBody:'Kingdom Network keeps the material source and status visible so members and leaders can tell current teaching from reference material.',home:'← Home',english:'English',spanish:'Español',church:'Your Church',feedback:'Something missing or confusing?',feedbackBody:'Send an idea or problem directly to the pilot feedback box.',feedbackCta:'Share feedback →'},
  es:{title:'¿Qué estás tratando de hacer?',subtitle:'Elige una sola cosa. Kingdom Guide te llevará al lugar correcto.',searchTitle:'Buscar recursos de la iglesia',searchBody:'¿Buscas una lección, tema bíblico, política, formulario o recurso de la iglesia?',search:'Buscar',placeholder:'Prueba: bautismo, oración, Primeros Pasos, ofrenda…',hint:'Los resultados vienen de recursos que tu iglesia ya guardó. Kingdom Guide no inventa doctrina ni reemplaza la fuente sin avisar.',quick:'COSAS COMUNES',leadership:'CONFIGURACIÓN Y LIDERAZGO',results:'RESULTADOS CONFIABLES',resultsFor:'Resultados para',none:'No encontramos un recurso de la iglesia que coincida. Prueba una palabra más sencilla o abre la Biblioteca de Recursos.',open:'Abrir en la Biblioteca de Recursos →',trust:'POR QUÉ ES CONFIABLE',trustTitle:'La fuente siempre queda visible.',trustBody:'Kingdom Network mantiene visible la fuente y el estado del material para distinguir enseñanza actual de material de referencia.',home:'← Inicio',english:'English',spanish:'Español',church:'Tu Iglesia',feedback:'¿Falta algo o algo es confuso?',feedbackBody:'Envía una idea o problema directamente al buzón de comentarios del piloto.',feedbackCta:'Compartir comentario →'}
} as const

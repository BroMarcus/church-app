...
export default function TeamsError({reset}:{reset:()=>void}){
  return <main style={{maxWidth:980,margin:'0 auto',padding:'28px 18px 80px'}}>
    <div role="alert" style={{border:'1px solid #fecaca',borderRadius:18,padding:24,background:'#fff'}}>
      ...
      <h1 style={{margin:'10px 0 8px'}}>Teams could not load.</h1>
      <p style={{margin:'0 0 16px',color:'#6b7280'}}>No assignment, response, or team membership was changed. / No se modificó ninguna asignación, respuesta ni membresía de equipo.</p>

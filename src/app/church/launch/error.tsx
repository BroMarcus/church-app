...
export default function ChurchLaunchError({reset}:{reset:()=>void}){
  return <main style={{maxWidth:1040,margin:'0 auto',padding:'28px 18px 80px'}}>
    <div role="alert" style={{border:'1px solid #fecaca',borderRadius:18,padding:24,background:'#fff'}}>
      <div style={{fontSize:12,fontWeight:800,letterSpacing:'.08em',textTransform:'uppercase'}}>Church Builder / Configuración</div>
      <h1 style={{margin:'10px 0 8px'}}>Church Builder could not load.</h1>
      <p style={{margin:'0 0 16px',color:'#6b7280'}}>Nothing in your church setup was changed. / No se cambió nada en la configuración de tu iglesia.</p>

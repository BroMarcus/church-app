...
export default function HelpError({reset}:{reset:()=>void}){
  return <main style={{maxWidth:960,margin:'0 auto',padding:'28px 18px 80px'}}>
    <div role="alert" style={{border:'1px solid #fecaca',borderRadius:18,padding:24,background:'#fff'}}>
      <div style={{fontSize:12,fontWeight:800,letterSpacing:'.08em',textTransform:'uppercase'}}>Help Center / Centro de Ayuda</div>
      <h1 style={{margin:'10px 0 8px'}}>Help could not load. / No se pudo cargar la ayuda.</h1>
      <p style={{margin:'0 0 16px',color:'#6b7280'}}>No church information or account settings were changed. / No se cambió ninguna información de la iglesia ni configuración de tu cuenta.</p>

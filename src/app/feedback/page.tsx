...
export default async function FeedbackPage({searchParams}:{searchParams:Promise<{lang?:string;sent?:string;error?:string}>}){
  ...
  {q.sent&&<div className="notice success">{t.sent}</div>}{q.error&&<div className="notice error">{q.error}</div>}

...
export default function HomeError({reset}:{reset:()=>void}){
  return <main style={{maxWidth:1180,margin:'0 auto',padding:'28px 18px 80px'}}>
    <div role="alert" style={{border:'1px solid #fecaca',borderRadius:18,padding:24,background:'#fff'}}>
      ...
      <h1 style={{margin:'10px 0 8px'}}>Home could not load.</h1>
      <p style={{margin:'0 0 16px',color:'#6b7280'}}>Your account, church information, and progress were not changed. / Tu cuenta, la información de tu iglesia y tu progreso no fueron modificados.</p>

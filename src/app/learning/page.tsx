...
export default async function LearningPage({searchParams}:{searchParams:Promise<{error?:string;lang?:string}>}){
  ...
  return <main className="shell">
    ...
    <section className="card" style={{padding:18,marginBottom:16}}><div className="pill">COURSE AWARDS</div><h2 style={{margin:'8px 0 6px'}}>Pass the final. Earn the level.</h2><p className="muted" style={{margin:'0 0 12px'}}>Every course requires all lessons plus a final exam score of at least 80% before completion is awarded.</p><div className="row" style={{gap:10,flexWrap:'wrap'}}><div className="card" style={{padding:'10px 14px',minWidth:150}}><strong>Silver</strong><div className="small muted">80–89%</div></div><div className="card" style={{padding:'10px 14px',minWidth:150}}><strong>Gold</strong><div className="small muted">90–99%</div></div><div className="card" style={{padding:'10px 14px',minWidth:150}}><strong>Platinum</strong><div className="small muted">100%</div></div></div></section>

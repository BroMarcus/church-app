...
export default function DocumentsError({reset}:{reset:()=>void}){
  return <main style={{maxWidth:980,margin:'0 auto',padding:'28px 18px 80px'}}>
    <div role="alert" style={{border:'1px solid #fecaca',borderRadius:18,padding:24,background:'#fff'}}>
      ...
      <h1 style={{margin:'10px 0 8px'}}>Documents could not load.</h1>
      <p style={{margin:'0 0 16px',color:'#6b7280'}}>No document, upload, or church record was changed. / No se modificó ningún documento, carga ni registro de la iglesia.</p>

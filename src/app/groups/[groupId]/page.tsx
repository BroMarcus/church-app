...
export default async function GroupDetailPage({params,searchParams}:{params:Promise<{groupId:string}>;searchParams:Promise<{error?:string;reported?:string;member?:string;details?:string;private?:string}>}){
  ...
  return <main className="shell">
    ...
    <GroupSettings group={group} privateDetails={privateDetails} canManage={canManage} canViewPrivate={canViewPrivate}/>

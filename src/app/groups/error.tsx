...
export default function GroupsError({reset}:{reset:()=>void}){
  return <main style={{maxWidth:1100,margin:'0 auto',padding:'28px 18px 80px'}}>
    <div role="alert" style={{border:'1px solid #fecaca',borderRadius:18,padding:24,background:'#fff'}}>
      <div style={{fontSize:12,fontWeight:800,letterSpacing:'.08em',textTransform:'uppercase'}}>Friendship Groups / Grupos de Amistad</div>
      <h1 style={{margin:'10px 0 8px'}}>Your groups could not load. / No se pudieron cargar tus grupos.</h1>
      <p style={{margin:'0 0 16px',color:'#6b7280'}}>Your group memberships and attendance information were not changed. / Tus membresías de grupo y tu información de asistencia no fueron modificadas.</p>

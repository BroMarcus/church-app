...
export default async function JourneyPage({searchParams}:{searchParams:Promise<{lang?:string}>}){
  ...
  const nextByKey:any={
    baptism:{title:t('Confirm your baptism record','Confirma tu registro de bautismo'),body:t('If you have been baptized in the name of Jesus Christ but it is not recorded here, ask a church leader to verify it.','Si has sido bautizado en el nombre de Jesucristo pero no aparece aquí, pide a un líder de la iglesia que lo verifique.'),href:`/help${lang}`,cta:t('Ask for help','Pedir ayuda')},
